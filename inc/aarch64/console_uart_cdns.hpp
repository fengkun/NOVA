...
class Console_cdns final : private Console_cdns_mmio, private Console_uart<Console_cdns, Console_cdns_mmio::Register>
{
    ...
    private:
        ...
        Console_cdns (Hpt::OAddr p) : Console_uart (p) {}
};
