...
class Sys_ipc_call : public Sys_regs
{
    public:
        ...
        bool no_helping() const { return flags() & 0x1; }
...
{
    public:
        bool glb() const { return flags() & 0x1; }

        bool vcpu() const { return flags() & 0x2; }

        bool fpu() const { return flags() & 0x4; }
...
class Sys_create_sc : public Sys_regs
{
    public:
        ...
        unsigned prio() const { return r[3] & 0x7f; }
};
...
class Sys_ctrl_pd : public Sys_regs
{
    public:
        ...
        Space::Type st() const { return Space::Type (r[2] & 0x3); }

        Space::Index si() const { return Space::Index (r[3] & 0x3); }

        unsigned ord() const { return r[2] >> 2 & 0x1f; }

        unsigned pmm() const { return r[3] >> 2 & 0x1f; }

        Memtype::Shareability sh() const { return Memtype::Shareability (r[3] >> 10 & 0x3); }

        Memtype::Index mt() const { return Memtype::Index (r[3] >> 7 & 0x7); }
};
...
class Sys_ctrl_sc : public Sys_regs
{
    public:
        ...
        void set_time_ms (uint64 val) { r[1] = val; }
};
...
class Sys_ctrl_sm : public Sys_regs
{
    public:
        ...
        bool op() const { return flags() & 0x1; }

        bool zc() const { return flags() & 0x2; }
...
{
    public:
        bool msk() const { return flags() & 0x1; }

        bool trg() const { return flags() & 0x2; }

        bool gst() const { return flags() & 0x8; }
