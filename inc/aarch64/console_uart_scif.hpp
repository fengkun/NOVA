...
class Console_scif final : private Console_scif_mmio, private Console_uart<Console_scif, Console_scif_mmio::Register>
{
    ...
    private:
        ...
        Console_scif (Hpt::OAddr p) : Console_uart (p) {}
};
