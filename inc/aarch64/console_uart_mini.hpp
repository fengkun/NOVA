...
class Console_mini final : private Console_mini_mmio, private Console_uart<Console_mini, Console_mini_mmio::Register>
{
    ...
    private:
        ...
        Console_mini (Hpt::OAddr p) : Console_uart (p) {}
};
