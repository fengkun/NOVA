...
class Console_pl011 final : private Console_pl011_mmio, private Console_uart<Console_pl011, Console_pl011_mmio::Register>
{
    ...
    private:
        ...
        Console_pl011 (Hpt::OAddr p) : Console_uart (p) {}
};
